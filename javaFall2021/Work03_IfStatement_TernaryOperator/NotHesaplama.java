...
public class NotHesaplama {
    public static void main(String[] args) {
        ...
        5. final notu double deðerinde olmalÄ±. (örn: 65,5)

        6.Kullanýcýya    "Final sýnavý yüzdesini giriniz"-->> double olmalý ->> 0,60 etkiliyor.

        7.ornek: Vize final ortalamasýný bulmak iÃ§in, vize nin yüzde40 ý, finalin yüzde 60 ý alýnmalý ve çýkan sonuçlar toplanmalýdýr.

        8. çýkan sonucu (dersin not ortalamasýný
        )   double toplam  ' a eþitleyebilirsiniz.
    	...
    	System.out.print("final sÄýnavý yüzdesini giriniz:");
