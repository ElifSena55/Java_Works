...
if (isim.length()==3) {
	...
	System.out.println("girilen isim 3 harfli deðil");
}
System.out.println("********ternary ile*******");

String sonuç=isim.length()==3 ? ((c1!=c2 && c2!=c3 && c1!=c3)? "girilen isim 3 harfli ve unique":"girilen isim 3 harfli ama unique deðil"):"girilen isim 3 harfli deðil";
